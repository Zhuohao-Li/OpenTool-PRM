            ...
            for batch_dict in self.train_dataloader:
                ...
                # with _timer('step', timing_raw):
                    ...
                    with _timer('adv', timing_raw):
                        ...
                        if hasattr(batch, 'llm_judge_metrics') and 'llm_judge_valid_rate' in batch.llm_judge_metrics:
                            metrics.update({
                                'reward/llm_judge_valid_rate': batch.llm_judge_metrics['llm_judge_valid_rate'],
                                'reward/llm_judge_valid_count': batch.llm_judge_metrics['llm_judge_valid_count'],
                                'reward/llm_judge_total_count': batch.llm_judge_metrics['llm_judge_total_count'],
                            })
